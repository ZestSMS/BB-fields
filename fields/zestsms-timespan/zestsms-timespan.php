...
function zestsms_timespan_field_assets() {
	if ( class_exists( 'FLBuilderModel' ) && FLBuilderModel::is_builder_active() ) {
		wp_enqueue_script( 'jquery-timepicker', ZESTSMS_FIELDS_URL . 'zestsms-timespan/js/lib/jquery.timepicker.min.js', array('jquery'), '1.8.0', true );
		wp_enqueue_script( 'zestsms-timespan', ZESTSMS_FIELDS_URL . 'zestsms-timespan/js/zestsms-timespan.js', array('jquery-timepicker'), '1.0', true );
		wp_enqueue_style('jquery-timepicker', ZESTSMS_FIELDS_URL . 'zestsms-timespan/css/lib/jquery.timepicker.css', false, null);
	}
}
