...
function zestsms_pdf_field_assets() {
    if ( class_exists( 'FLBuilderModel' ) && FLBuilderModel::is_builder_active() ) {
    		wp_enqueue_style( 'zestsms-pdf', JHB_FIELDS_URL . 'pdf/css/zestsms-pdf.css', array(), '' );
        wp_enqueue_script( 'zestsms-pdf', JHB_FIELDS_URL . 'pdf/js/zestsms-pdf.js', array(), '', true );
    }
}
